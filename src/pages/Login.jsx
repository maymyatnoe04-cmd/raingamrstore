...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] px-4 relative z-10">
      ...
      >
        <h1 className="text-3xl font-bold text-sky-900 text-center mb-8">Login</h1>
        ...
        <p className="text-center mt-6 text-sky-700">
          Don't have an account? <Link to="/register" className="font-bold text-sky-900 hover:underline">Register</Link>
        </p>
      </motion.div>
    </div>
  )
